                    ...
                    >
                        ...
                        >
                            ...
                            <div className="pt-3 px-6 relative">
                                <h2 className="text-black text-2xl md:text-3xl font-bold font-bebas">ОСТАВЬТЕ
                                    ЗАЯВКУ</h2>
                                <p className="text-[#0E3D91] text-2xl md:text-3xl font-bold font-bebas">И МЫ С ВАМИ
                                    СВЯЖЕМСЯ</p>
                            ...
                            <form onSubmit={handleSubmit} className="p-6">
                                <div className="space-y-4">
                                    <div
                                        className="bg-white border-1 border-[#BABABA] py-2 px-2 md:py-4 md:px-4 rounded-lg flex flex-row items-center gap-2">
                                            ...
                                            <div className="flex items-center space-x-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[12px] md:text-[14px] text-gray-500">
                                                        это усовершенствованный вариант классического LASIK, при котором
                                                        оба этапа операции
                                        ...
                                        >
                                            <div className="flex items-center space-x-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[12px] md:text-[14px] text-gray-500">
                                                        это новейшая технология лазерной коррекции зрения,
