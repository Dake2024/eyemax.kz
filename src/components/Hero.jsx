                ...
                <div className="flex flex-col md:hidden w-full justify-center relative">
                    ...
                    >
                        ...
                        <div className="absolute flex flex-col items-center bottom-15">
                            ...
                            <p className="text-center text-red-600 text-[32px] font-bold font-bebas bg-white w-full p-1 mt-2 shadow-[0px_2px_10px_4px_rgba(101,170,243,0.5)]">Ограничения по возрасту 18-45!</p>
                            <button
                                onClick={onOpenModal}
