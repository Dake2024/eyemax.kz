        ...
        <div className="pt-2 md:pt-6 md:pb-24 md:px-[6%] bg-[#C0C0C0] md:bg-[#F9F9F9]">
                <div className="hidden md:flex flex-row gap-24 items-center">
                    <div className="flex flex-col gap-8 font-gilroy">
                        ...
                        <p className="text-2xl font-bold"><span className="text-[#2968F6]">Лазерная коррекция</span> зрения “Femto LASIK” — по суперцене <span className="text-[#2968F6]">380 000 тг</span> за оба глаза только <span className="text-[#2968F6]">до конца октября!</span></p>
